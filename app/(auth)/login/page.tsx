          ...
          <div style={{background: '#fff', borderRadius: '4px', border: '1px solid #E8E3DA', padding: '32px'}}>
            ...
            <button
              ...
              style={{
                ...
                opacity: loading || !supabaseReady ? 0.5 : 1,
            ...
            <div style={{position: 'relative', margin: '24px 0'}}>
              <div style={{position: 'absolute', inset: 0, display: 'flex', alignItems: 'center'}}>
                <div style={{width: '100%', borderTop: '1px solid #E8E3DA'}} />
              </div>
              <div style={{position: 'relative', display: 'flex', justifyContent: 'center'}}>
                <span style={{background: '#fff', padding: '0 12px', fontSize: '12px', textTransform: 'uppercase', color: '#9A9488', fontFamily: "'IBM Plex Mono', monospace", letterSpacing: '0.1em'}}>or</span>
              </div>
            </div>
