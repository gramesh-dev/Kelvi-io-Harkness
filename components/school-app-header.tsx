...
const navItems = [
  ...
  { href: "/school/account", label: "My account" },
];

export function SchoolAppHeader({
  userName,
  userEmail,
  orgName,
}: {
    ...
    <header className="shrink-0 border-b border-kelvi-border bg-kelvi-cream">
      <div className="max-w-6xl mx-auto px-6 py-4 flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3 min-w-0">
          <Link href="/school" className="flex items-center gap-2.5 shrink-0">
            <span
            ...
            <span className="text-sm font-medium text-kelvi-muted">School</span>
          </Link>
          {orgName ? (
            <span
